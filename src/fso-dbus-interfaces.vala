...
/* Generated with: /usr/bin/vala-dbus-binding-tool --api-path=../fso/specs.git/xml/ --output=src/fso-dbus-interfaces.vala --strip-namespace=org --rename-namespace=freedesktop:FreeDesktop --rename-namespace=freesmartphone:FreeSmartphone */
using DBus;
using GLib;
